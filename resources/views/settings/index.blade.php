...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="sidebarheader"><p>{{ __('Database Management') }}</p></div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                <div class="tablet movedown">
                    <div class="tablet__head slim">
                        <div class="tablet__head-label">
                            <h3 class="tablet__head-title">{{ __('Database Reset') }}</h3>
                        </div>
                    </div>
                    <div class="tablet__body">
                        <p class="small">{{ __('Reset the database by truncating all tables and optionally seeding initial data') }}</p>
                        <a href="{{ route('settings.database') }}" class="btn btn-danger">{{ __('Reset Database') }}</a>
                    </div>
                </div>
            </div>
        </div>
